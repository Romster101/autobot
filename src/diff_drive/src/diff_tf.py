...
#############################################################################
    ...
    #############################################################################
        ...
        #### parameters #######
        self.rate = rospy.get_param('~rate',9.0)  # the rate at which to publish the transform
        self.ticks_meter = float(rospy.get_param('ticks_meter', 16160))  # The number of wheel encoder ticks per meter of travel
